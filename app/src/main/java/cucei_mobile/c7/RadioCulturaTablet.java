...
public class RadioCulturaTablet extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, MediaController.MediaPlayerControl
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_radio_cultura_tablet);
        ...
        botonInicio.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(RadioCulturaTablet.this, Inicio.class);
                exitOnButton(intent);
            }
        });
        ...
        botonMenu.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(RadioCulturaTablet.this, Menu_Cultura.class);
                exitOnButton(intent);
            }
        });
        ...
        botonProgramacion.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(RadioCulturaTablet.this, MenuProgramacion_Cultura.class);
                exitOnButton(intent);
            }
        });
        /*RADIO*/
    ...
    {
        Intent intent = new Intent(this, RadioBandera.class);
        PendingIntent pIntent = PendingIntent.getActivity(this, 0, intent, 0);
        Notification noti = new Notification.Builder(this)
                .setContentTitle("C7 Cultura")
