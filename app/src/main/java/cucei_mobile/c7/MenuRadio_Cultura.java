...
public class MenuRadio_Cultura extends Activity
{
    ...
    int[] mResources =
    {
            R.drawable.leones_negros_cultura,
            R.drawable.plazasesamo_cultura
    };
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            setContentView(R.layout.activity_menu_radio_cultura_tablet);
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        else
            setContentView(R.layout.activity_menu_radio_cultura);
        ...
        imgFMGdl.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(func.esTablet(getApplicationContext()))
                {
                    Intent intent = new Intent(MenuRadio_Cultura.this, RadioCulturaTablet.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("plataforma", canal);
                    startActivity(intent);
                }
                else
                {
                    Intent intent = new Intent(MenuRadio_Cultura.this, RadioCultura.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("plataforma", canal);
                    startActivity(intent);
                }
                estaReproduciendo();
        ...
        if(func.esTablet(getApplicationContext()))
        {
            ...
            imgLinkPagina.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(MenuRadio_Cultura.this, WebViewC7.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("plataforma", "cultura");
                    startActivity(intent);
                }
            });
        ...
        botonInicio.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(MenuRadio_Cultura.this, Inicio.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        botonMenu.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent  = new Intent(MenuRadio_Cultura.this, Menu_Cultura.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        botonProgramacion.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent  = new Intent(MenuRadio_Cultura.this, MenuProgramacion_Cultura.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
