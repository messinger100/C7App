...
public class RadioNoticias extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, MediaController.MediaPlayerControl
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_radio_noticias);
        ...
        botonInicio.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(RadioNoticias.this, Inicio.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                exitOnButton(intent);
            }
        });
        ...
        botonMenu.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(RadioNoticias.this, Menu_Noticias.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                exitOnButton(intent);
            }
        });
        ...
        botonProgramacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(RadioNoticias.this, MenuProgramacion_Noticias.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                exitOnButton(intent);
            }
        });
