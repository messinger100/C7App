...
public class MenuProgramacion_Noticias extends Activity
{
    ...
    int[] mResources =
    {
            R.drawable.plataformanoticias0,
            R.drawable.plataformanoticias1,
            R.drawable.plataformanoticias2
    };
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            setContentView(R.layout.activity_menu_programacion_noticias_tablet);
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        else
            setContentView(R.layout.activity_menu_programacion_noticias);
        ...
        ImageButton imgTVNoticias = (ImageButton)findViewById(R.id.imgTVNoticias);
        imgTVNoticias.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                canal = "noticias";
                Intent intent = new Intent(MenuProgramacion_Noticias.this, MenuProgramacionPlataforma_Noticias.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        imgTwitter.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(MenuProgramacion_Noticias.this, RedesSociales.class);
        ...
        imgClasicos.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(MenuProgramacion_Noticias.this, RadioCultura.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        if(func.esTablet(getApplicationContext()))
        {
            ...
            imgLinkPagina.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    Intent intent = new Intent(MenuProgramacion_Noticias.this, WebViewC7.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("plataforma", "noticias");
                    startActivity(intent);
                }
            });
        ...
        botonInicio.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(MenuProgramacion_Noticias.this, Inicio.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        botonMenu.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent intent  = new Intent(MenuProgramacion_Noticias.this, Menu_Noticias.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        tiempo();
