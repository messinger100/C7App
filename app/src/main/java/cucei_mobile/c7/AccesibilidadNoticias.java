...
public class AccesibilidadNoticias extends Activity
{
    ...
    private void time()
    {
        timer.schedule(new TimerTask()
        {
            public void run()
            {
                Intent intent = new Intent(AccesibilidadNoticias.this, AccesibilidadNoticias.class);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            setContentView(R.layout.activity_accesibilidad_noticias_tablet);
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        else
            setContentView(R.layout.activity_accesibilidad_noticias);
        ...
        imgClasicos.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {;
                Intent intent = new Intent(getApplicationContext(), RadioCultura.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public void obtener()
    {
        ...
        if(func.esTablet(getApplicationContext()))
            ...
            txvCanalesAbierta.setTextSize(16);
        String query = "";
        query = "SELECT titulo FROM canales WHERE plataforma='noticias' AND tipo_access='abierta'";
        //TV ABIERTA
        try
        {
        ...
        //CABLE
        query = "SELECT * FROM canales WHERE plataforma='noticias' AND tipo_access='cable'";
        try
        {
            AdminSQLiteOpenHelper admin= new AdminSQLiteOpenHelper(this,func.myPath,null,1);
            SQLiteDatabase sql= admin.getWritableDatabase();
        ...
        //RADIO
        query = "SELECT * FROM canales WHERE plataforma='noticias' AND tipo_access='radio'";
        try
        {
            AdminSQLiteOpenHelper admin= new AdminSQLiteOpenHelper(this,func.myPath,null,1);
            SQLiteDatabase sql= admin.getWritableDatabase();
    ...
    class accessJSON extends AsyncTask<String, String, JSONObject[]>
    {
        ...
        protected JSONObject[] doInBackground(String... urls)
        {
            ...
            objetos[0] = jParser.makeHttpRequest("http://c7jalisco.com/services/canales-noticias");
            objetos[1] = jParser.makeHttpRequest("http://c7jalisco.com/services/canales-noticias-cable");
            objetos[2] = jParser.makeHttpRequest("http://c7jalisco.com/services/canales-noticias-radio");
